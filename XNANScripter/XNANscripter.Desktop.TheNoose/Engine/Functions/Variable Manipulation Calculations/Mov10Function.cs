...
{
    internal class Mov10Function : Function
    {
        public string name { get { return "mov10"; } set { } }

        public List<string> parameters { get; set; }

        public Mov10Function()
        {
        }
        ...
        public async System.Threading.Tasks.Task Run()
        {
            ...
            for (int i = int.Parse(parameters[0]); i < int.Parse(parameters[0]) + 10; i++)
            {
